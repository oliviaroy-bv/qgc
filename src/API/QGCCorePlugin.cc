...
void QGCCorePlugin::factValueGridCreateDefaultSettings(FactValueGrid* factValueGrid)
{
    ...
    if (factValueGrid->specificVehicleForCard()) {
        ...
        // 5 columns x 2 rows to match telemetry bar layout
        ...
        // Column 0: Alt(Rel) / Distance to Home
        int rowIndex = 0;
        ...
        // Column 1: Climb Rate / Ground Speed
        rowIndex = 0;
        ...
        // Column 2: Flight Time / Flight Distance
        rowIndex = 0;
