...
// Looks good, but can be modified
// import QtQuick
...
//         Item {
//             implicitWidth:  260
//             implicitHeight: Math.max(580, menuColumn.implicitHeight + 220)
...
//                 Rectangle {
//                     anchors.fill:   parent
//                     color:          Qt.rgba(0.04, 0.047, 0.09, 0.92)
//                 }
...
//                                 radius:             39
//                                 color:              "transparent"
//                                 border.color:       Qt.rgba(0.0, 0.83, 1.0, 0.25)
//                                 border.width:       1
//                             }
...
//                                 height:             68
//                                 radius:             34
//                                 color:              Qt.rgba(0.0, 0.83, 1.0, 0.08)
//                                 border.color:       Qt.rgba(0.0, 0.83, 1.0, 0.20)
//                                 border.width:       1

//                                 // Top shimmer on logo circle
//                                 Rectangle {
//                                     anchors.top:                parent.top
//                                     anchors.topMargin:          1
//                                     anchors.horizontalCenter:   parent.horizontalCenter
...
//                         itemText:       qsTr("Flight")
//                         showArrow:      false
//                         isActive:       true       // mark current view
//                         onNavClicked: {
//                             if (mainWindow.allowViewSwitch()) {
//                                 mainWindow.closeIndicatorDrawer()
...
//                     radius:         14     // only bottom corners matter but full radius clips fine
//                 }
...
//                             radius:             5
//                             samples:            11
//                             color:              Qt.rgba(0.0, 0.83, 1.0, 0.25)
//                             transparentBorder:  true
//                         }
//                     }
//                 }
...
//                     radius:                 8
//                     color: {
//                         if (navItem._prs)       return Qt.rgba(0.0, 0.83, 1.0, 0.14)
//                         if (navItem._hov)       return Qt.rgba(1, 1, 1, 0.07)
//                         if (navItem.isActive)   return Qt.rgba(0.0, 0.83, 1.0, 0.08)
//                         return "transparent"
//                     }
//                     border.color: {
//                         if (navItem._prs || navItem.isActive) return Qt.rgba(0.0, 0.83, 1.0, 0.30)
//                         if (navItem._hov)                     return Qt.rgba(1, 1, 1, 0.10)
//                         return "transparent"
//                     }
//                     border.width: 1
...
//                         fillMode:               Image.PreserveAspectFit
//                         color: {
//                             if (navItem._hov || navItem._prs) return Qt.rgba(0.0, 0.83, 1.0, 1.0)
//                             if (navItem.isActive)             return Qt.rgba(0.0, 0.83, 1.0, 0.90)
...
//                         color: {
//                             if (navItem._hov || navItem._prs) return Qt.rgba(1, 1, 1, 1.0)
//                             if (navItem.isActive)             return Qt.rgba(0.0, 0.83, 1.0, 0.95)
...
//                 // Arrow chevron (for items with sub-pages)
//                 Text {
//                     anchors.right:          parent.right
//                     anchors.rightMargin:    20
//                     anchors.verticalCenter: parent.verticalCenter
//                     visible:                navItem.showArrow
//                     text:                   "›"
//                     font.pixelSize:         20
//                     color: {
//                         if (navItem._hov || navItem._prs) return Qt.rgba(0.0, 0.83, 1.0, 0.90)
